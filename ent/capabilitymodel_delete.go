...
func (_d *CapabilityModelDelete) Where(ps ...predicate.CapabilityModel) *CapabilityModelDelete {
...
func (_d *CapabilityModelDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(capabilitymodel.Table, sqlgraph.NewFieldSpec(capabilitymodel.FieldID, field.TypeString))
...
type CapabilityModelDeleteOne struct {
	_d *CapabilityModelDelete
}

// Where appends a list predicates to the CapabilityModelDelete builder.
func (_d *CapabilityModelDeleteOne) Where(ps ...predicate.CapabilityModel) *CapabilityModelDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *CapabilityModelDeleteOne) Exec(ctx context.Context) error {
	n, err := _d._d.Exec(ctx)
	switch {
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{capabilitymodel.Label}
	default:
		return nil
	}
}
