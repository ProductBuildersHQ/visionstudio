...
func (_d *DeliveryEvidenceDelete) Where(ps ...predicate.DeliveryEvidence) *DeliveryEvidenceDelete {
...
func (_d *DeliveryEvidenceDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(deliveryevidence.Table, sqlgraph.NewFieldSpec(deliveryevidence.FieldID, field.TypeString))
...
type DeliveryEvidenceDeleteOne struct {
	_d *DeliveryEvidenceDelete
}

// Where appends a list predicates to the DeliveryEvidenceDelete builder.
func (_d *DeliveryEvidenceDeleteOne) Where(ps ...predicate.DeliveryEvidence) *DeliveryEvidenceDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *DeliveryEvidenceDeleteOne) Exec(ctx context.Context) error {
	n, err := _d._d.Exec(ctx)
	switch {
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{deliveryevidence.Label}
	default:
		return nil
	}
}
