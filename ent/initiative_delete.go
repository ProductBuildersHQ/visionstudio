...
func (_d *InitiativeDelete) Where(ps ...predicate.Initiative) *InitiativeDelete {
...
func (_d *InitiativeDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(initiative.Table, sqlgraph.NewFieldSpec(initiative.FieldID, field.TypeString))
...
// Where appends a list predicates to the InitiativeDelete builder.
func (_d *InitiativeDeleteOne) Where(ps ...predicate.Initiative) *InitiativeDeleteOne {
...
func (_d *InitiativeDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{initiative.Label}
	default:
		return nil
	}
}
