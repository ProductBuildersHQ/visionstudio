...
func (_d *JudgeResultDelete) Where(ps ...predicate.JudgeResult) *JudgeResultDelete {
...
func (_d *JudgeResultDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(judgeresult.Table, sqlgraph.NewFieldSpec(judgeresult.FieldID, field.TypeString))
...
type JudgeResultDeleteOne struct {
	_d *JudgeResultDelete
}

// Where appends a list predicates to the JudgeResultDelete builder.
func (_d *JudgeResultDeleteOne) Where(ps ...predicate.JudgeResult) *JudgeResultDeleteOne {
...
func (_d *JudgeResultDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{judgeresult.Label}
	default:
		return nil
	}
}
