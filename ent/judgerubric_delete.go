...
func (_d *JudgeRubricDelete) Where(ps ...predicate.JudgeRubric) *JudgeRubricDelete {
...
func (_d *JudgeRubricDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(judgerubric.Table, sqlgraph.NewFieldSpec(judgerubric.FieldID, field.TypeString))
...
type JudgeRubricDeleteOne struct {
	_d *JudgeRubricDelete
}

// Where appends a list predicates to the JudgeRubricDelete builder.
func (_d *JudgeRubricDeleteOne) Where(ps ...predicate.JudgeRubric) *JudgeRubricDeleteOne {
...
func (_d *JudgeRubricDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{judgerubric.Label}
	default:
		return nil
	}
}
