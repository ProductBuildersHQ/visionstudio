...
func (_c *PersonCreate) SetNillableDisplayName(v *string) *PersonCreate {
	if v != nil {
		_c.SetDisplayName(*v)
	}
	return _c
...
func (_c *PersonCreate) SetEmailIdentities(v []string) *PersonCreate {
	_c.mutation.SetEmailIdentities(v)
	return _c
}
...
func (_c *PersonCreate) SetID(v string) *PersonCreate {
	_c.mutation.SetID(v)
	return _c
}

// AddOrganizationIDs adds the "organizations" edge to the Organization entity by IDs.
func (_c *PersonCreate) AddOrganizationIDs(ids ...string) *PersonCreate {
...
func (_c *PersonCreate) check() error {
	...
	if v, ok := _c.mutation.ID(); ok {
		if err := person.IDValidator(v); err != nil {
			return &ValidationError{Name: "id", err: fmt.Errorf(`ent: validator failed for field "Person.id": %w`, err)}
		}
	}
	return nil
}
...
func (_c *PersonCreate) createSpec() (*Person, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.EmailIdentities(); ok {
		_spec.SetField(person.FieldEmailIdentities, field.TypeJSON, value)
		_node.EmailIdentities = value
	}
