...
func (_d *RMIDependencyDelete) Where(ps ...predicate.RMIDependency) *RMIDependencyDelete {
...
func (_d *RMIDependencyDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(rmidependency.Table, sqlgraph.NewFieldSpec(rmidependency.FieldID, field.TypeInt))
...
type RMIDependencyDeleteOne struct {
	_d *RMIDependencyDelete
}

// Where appends a list predicates to the RMIDependencyDelete builder.
func (_d *RMIDependencyDeleteOne) Where(ps ...predicate.RMIDependency) *RMIDependencyDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *RMIDependencyDeleteOne) Exec(ctx context.Context) error {
	n, err := _d._d.Exec(ctx)
	switch {
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{rmidependency.Label}
	default:
		return nil
	}
}
